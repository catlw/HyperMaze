...
var (
	...
	RinkebyChainConfig = &ChainConfig{
		...
		/// TODO: PBFT's config parameters should be initiated here. --Zhiguo
		PBFT: &PBFTConfig{
			Period: 15,
			Epoch:  30000,
		}, //=>TODO add PBFT --Agzs
...
type ChainConfig struct {
	...
	PBFT   *PBFTConfig   `json:"pbft,omitempty"` /// added for PBFT. ---Zhiguo
...
/////////////////////////////////////////
/// for PBFT. ---Zhiguo
// PBFTConfig is the consensus engine configs for proof-of-authority based sealing.
...
func (c *ChainConfig) String() string {
	...
	case c.Clique != nil:
		engine = c.Clique
	case c.PBFT != nil: ///  for PBFT   ---Zhiguo
		engine = c.PBFT
	default:
		engine = "unknown"
	}
