...
var DefaultConfig = Config{
	SyncMode:             downloader.FastSync, //=>this will cause "Discarded bad propagated block" --Agzs
	EthashCacheDir:       "ethash",
	EthashCachesInMem:    2,
	EthashCachesOnDisk:   3,
	EthashDatasetsInMem:  1,
	EthashDatasetsOnDisk: 2,
	BlockchainId:         0, //=> add for blockchain number --Agzs 12.25
	NetworkId:            1,
	PbftId:               pbft.DefaultPbftID, ///  Zhiguo //=> change 0 -> 1000 --Agzs 12.13
	LightPeers:           20,
	DatabaseCache:        128,
