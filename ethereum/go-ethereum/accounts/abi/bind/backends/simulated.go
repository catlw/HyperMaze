...
func (b *SimulatedBackend) SendTransaction(ctx context.Context, tx *types.Transaction) error {
	b.mu.Lock()
	defer b.mu.Unlock()
    //log.Info("-------sendTransaction") ////xiaobei 1.10
	...
	b.pendingBlock = blocks[0]
	//fmt.Printf("-------pendingBlock's root is %x/n",b.pendingBlock.Root()) ////xiaobei 1.10
	//fmt.Printf("-------pendingBlock's root is ",b.pendingBlock.Root()) ////xiaobei 1.10
	b.pendingState, _ = state.New(b.pendingBlock.Root(), state.NewDatabase(b.database))
	return nil
}
